        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 p-8 bg-slate-50 border-y border-slate-100'>
              ...
              {['Men', 'Women', 'Kids'].map(item => (
                <label key={item} className='flex items-center gap-3 group cursor-pointer'>
                  <input
                    ...
                    checked={category.includes(item)} // THIS FIXES THE RESET ISSUE
              ...
              {['Topwear', 'Bottomwear', 'Winterwear'].map(item => (
                <label key={item} className='flex items-center gap-3 group cursor-pointer'>
                  <input
                    ...
                    checked={subCategory.includes(item)} // THIS FIXES THE RESET ISSUE
                    className='w-4 h-4 accent-slate-900 cursor-pointer'
                  />
                  <span className='text-sm text-slate-600 group-hover:text-black transition-colors'>{item}</span>
                </label>
          ...
          <div className='flex flex-col justify-end'>
            <button
              ...
              className='text-xs font-bold underline text-slate-400 hover:text-red-500 transition-colors uppercase text-left w-fit'
            >
              Reset Filters
            </button>
          </div>
